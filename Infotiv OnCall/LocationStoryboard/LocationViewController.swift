...
class LocationViewController: UIViewController, UITabBarControllerDelegate, UITableViewDataSource {
    ...
    private func populateCells() {
        data = [CellData.init(image: nil, tableTitle: "Car Location", tableDescription: "N/A"), CellData.init(image: nil, tableTitle: "Distance To Car", tableDescription: "N/A")]
    }
